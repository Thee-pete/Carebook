...
namespace CarebookPro
{
    internal class Db
    {
        ...
        {
            SqlDataAdapter da = new SqlDataAdapter("SELECT * FROM [doctor_information] ORDER BY [drfirstname]", ConfigurationManager.ConnectionStrings["Dbconnstring"].ConnectionString);
        ...
        {
            SqlDataAdapter da = new SqlDataAdapter("SELECT * FROM [doctor_information] WHERE [DoctorId] = @id", ConfigurationManager.ConnectionStrings["Dbconnstring"].ConnectionString);
        ...
        {
            SqlDataAdapter da = new SqlDataAdapter("SELECT * FROM [Appointment] WHERE [AppointmentId] = @id", ConfigurationManager.ConnectionStrings["Dbconnstring"].ConnectionString);
            da.SelectCommand.Parameters.AddWithValue("id", id);
        ...
        {
            SqlDataAdapter da = new SqlDataAdapter("SELECT * FROM [Appointment] WHERE [DoctorId] = @doctor AND NOT (([AppointmentEnd] <= @start) OR ([AppointmentStart] >= @end))", ConfigurationManager.ConnectionStrings["Dbconnstring"].ConnectionString);
        ...
        {
            SqlDataAdapter da = new SqlDataAdapter("SELECT * FROM [Appointment] WHERE NOT (([AppointmentEnd] <= @start) OR ([AppointmentStart] >= @end))", ConfigurationManager.ConnectionStrings["Dbconnstring"].ConnectionString);
            da.SelectCommand.Parameters.AddWithValue("start", start);
            da.SelectCommand.Parameters.AddWithValue("end", end);
            DataTable dt = new DataTable();
            da.Fill(dt);
        ...
        {
            SqlDataAdapter da = new SqlDataAdapter("SELECT * FROM [Appointment] WHERE ([AppointmentStatus] = 'free' OR ([AppointmentStatus] <> 'free' AND [AppointmentPatientSession] = @session)) AND NOT (([AppointmentEnd] <= @start) OR ([AppointmentStart] >= @end))", ConfigurationManager.ConnectionStrings["Dbconnstring"].ConnectionString);
        ...
        {
            SqlDataAdapter da = new SqlDataAdapter("SELECT top 1 * FROM [doctor_information] ORDER BY [drfirstname]", ConfigurationManager.ConnectionStrings["Dbconnstring"].ConnectionString);
