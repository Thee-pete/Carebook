<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LogInDoctor.aspx.cs" Inherits="CarebookPro.LogInDoctor" %>
...
<body>
  ...
  <div class="form">
    <form  class="register-form">
        ...
        <asp:TextBox runat="server" placeholder="Username" ID="docusername"></asp:TextBox>
        <asp:TextBox runat="server" placeholder="Password" type="password" ID="docpassword"></asp:TextBox>
        <asp:Button  runat="server"   class="button" Text="Log In" BackColor="#08363B" OnClick="DoctorLogIn_Click" />
        <asp:Literal runat="server" ID="litmsg"></asp:Literal>
       <p class="message">Don't have an account? <a href="SignUpDoctor.aspx">Sign Up</a></p>
    </form>
